...
(function () {
    ...
    var state = {
      ...
      calcGame: (function () {
        ...
        Object.keys(localStorage).forEach(function (k) {
          if (k.indexOf('imm-l3-calcgame::' + pageKey + '::') === 0) out[k] = loadJSON(k, null);
        });
        return out;
      })()
    };
  ...
  function initCalcQuest(containerId, opts) {
    ...
    var storageKey = 'imm-l3-calcgame::' + pageKey + '::' + containerId;
    var FUEL_START = 100;
    var FUEL_PENALTY = 15;
    var FACILITATOR_PIN = '26';
    ...
    function renderComplete() {
      if (opts.completionReflId) {
        saveJSON('imm-l3-reflect::' + pageKey + '::' + opts.completionReflId, { success: true, text: 'Mission complete', attempts: state.attempts.reduce(function (a, b) { return a + b; }, 0) });
      }
      stageArea.innerHTML = '';
